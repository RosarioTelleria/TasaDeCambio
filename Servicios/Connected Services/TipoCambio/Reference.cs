...
namespace TipoCambio
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://servicios.bcn.gob.ni/", ConfigurationName="TipoCambio.Tipo_Cambio_BCNSoap")]
    public interface Tipo_Cambio_BCNSoap
    {
        ...
        System.Threading.Tasks.Task<TipoCambio.RecuperaTC_MesResponse> RecuperaTC_MesAsync(TipoCambio.RecuperaTC_MesRequest request);
    }
    ...
    public partial class RecuperaTC_MesRequest
    {
        ...
        public TipoCambio.RecuperaTC_MesRequestBody Body;
        
        public RecuperaTC_MesRequest()
        {
        }
        
        public RecuperaTC_MesRequest(TipoCambio.RecuperaTC_MesRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class RecuperaTC_MesResponse
    {
        ...
        public TipoCambio.RecuperaTC_MesResponseBody Body;
        
        public RecuperaTC_MesResponse()
        {
        }
        
        public RecuperaTC_MesResponse(TipoCambio.RecuperaTC_MesResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface Tipo_Cambio_BCNSoapChannel : TipoCambio.Tipo_Cambio_BCNSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class Tipo_Cambio_BCNSoapClient : System.ServiceModel.ClientBase<TipoCambio.Tipo_Cambio_BCNSoap>, TipoCambio.Tipo_Cambio_BCNSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<TipoCambio.RecuperaTC_MesResponse> TipoCambio.Tipo_Cambio_BCNSoap.RecuperaTC_MesAsync(TipoCambio.RecuperaTC_MesRequest request)
        {
            return base.Channel.RecuperaTC_MesAsync(request);
        }
        
        public System.Threading.Tasks.Task<TipoCambio.RecuperaTC_MesResponse> RecuperaTC_MesAsync(int Ano, int Mes)
        {
            TipoCambio.RecuperaTC_MesRequest inValue = new TipoCambio.RecuperaTC_MesRequest();
            inValue.Body = new TipoCambio.RecuperaTC_MesRequestBody();
            inValue.Body.Ano = Ano;
            inValue.Body.Mes = Mes;
            return ((TipoCambio.Tipo_Cambio_BCNSoap)(this)).RecuperaTC_MesAsync(inValue);
        }
